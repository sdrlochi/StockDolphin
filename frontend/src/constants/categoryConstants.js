...
//1. Create note constants (createNote)
...
export const CATEGORY_DETAIL_REQUEST = "CATEGORY_LIST_REQUEST";
export const CATEGORY_DETAIL_SUCCESS = "CATEGORY_LIST_SUCCESS";
export const CATEGORY_DETAIL_FAIL = "CATEGORY_LIST_FAIL";
